...
const CommentTableItem = ({comment, fetchComments}) => {
  ...
  const deleteComment = async () => {
    try {
      ...
      const confirm = window.confirm("Are you sure do you want to delete this comment?")
        ...
        <div className='inline-flex items-center gap-4'>
          {
            ...
            <p className='border-green-600 bg-green-100 text-green-600 rounded-full px-3 py-1 text-xs border'>Approved</p> 
          }
